    ...
    <div className="min-h-screen bg-gray-50 dark:bg-navy-900 flex items-center justify-center px-4 py-8 sm:py-12 w-full transition-colors duration-200">
      <div className="w-full max-w-md mx-auto">
        <div className="bg-white dark:bg-navy-800 rounded-xl shadow-lg p-6 sm:p-8 border border-transparent dark:border-navy-700">
          ...
          {error && (
            <div className="text-red-600 dark:text-red-400 text-sm mb-4 text-center bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-2">
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-white dark:bg-white text-black dark:text-black py-2.5 rounded-lg text-sm sm:text-base font-medium hover:bg-gray-100 dark:hover:bg-gray-200 transition disabled:opacity-50"
            >
